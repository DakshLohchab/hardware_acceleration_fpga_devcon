...
entity yolo_conv_layer_start_for_conv2d_core_U0 is 
    generic (
...
architecture rtl of yolo_conv_layer_start_for_conv2d_core_U0 is
...
------------------------Component----------------------
    component yolo_conv_layer_start_for_conv2d_core_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_yolo_conv_layer_start_for_conv2d_core_U0_ShiftReg : yolo_conv_layer_start_for_conv2d_core_U0_ShiftReg
    generic map (
...
entity yolo_conv_layer_start_for_conv2d_core_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end yolo_conv_layer_start_for_conv2d_core_U0_ShiftReg;

architecture rtl of yolo_conv_layer_start_for_conv2d_core_U0_ShiftReg is
