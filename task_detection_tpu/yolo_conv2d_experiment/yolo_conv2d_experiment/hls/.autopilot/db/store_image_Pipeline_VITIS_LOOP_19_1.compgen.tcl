...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler yolo_conv_layer_ctlz_16_16_1_1 BINDTYPE {op} TYPE {ctlz} IMPL {auto}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out_dout { I 256 vector } stream_out_empty_n { I 1 bit } stream_out_read { O 1 bit } stream_out_num_data_valid { I 3 vector } stream_out_fifo_cap { I 3 vector } } \
} "
}
