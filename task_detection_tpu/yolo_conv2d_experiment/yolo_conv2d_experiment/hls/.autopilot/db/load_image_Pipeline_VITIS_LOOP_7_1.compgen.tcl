...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_in_din { O 48 vector } stream_in_full_n { I 1 bit } stream_in_write { O 1 bit } stream_in_num_data_valid { I 3 vector } stream_in_fifo_cap { I 3 vector } } \
} "
}
