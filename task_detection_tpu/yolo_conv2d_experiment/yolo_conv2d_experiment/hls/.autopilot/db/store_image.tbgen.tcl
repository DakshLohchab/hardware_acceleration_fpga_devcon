...
set C_modelArgList {
	{ stream_out int 256 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "stream_out", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stream_out_dout sc_in sc_lv 256 signal 0 } 
	{ stream_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ stream_out_read sc_out sc_logic 1 signal 0 } 
	{ stream_out_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ stream_out_fifo_cap sc_in sc_lv 3 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "stream_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	stream_out { ap_fifo {  { stream_out_dout fifo_data_out 0 256 }  { stream_out_empty_n fifo_status_empty 0 1 }  { stream_out_read fifo_data_in 1 1 }  { stream_out_num_data_valid fifo_update 0 3 }  { stream_out_fifo_cap fifo_data 0 3 } } }
