set moduleName load_image_Pipeline_VITIS_LOOP_7_1
set isTopModule 0
...
set cdfgNum 14
set C_modelName {load_image_Pipeline_VITIS_LOOP_7_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0 stable }  }
	{ sext_ln7 int 62 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "image_in","offset": { "type": "dynamic","port_name": "image_in","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln7", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stream_in_din sc_out sc_lv 48 signal 2 } 
	...
	{ sext_ln7 sc_in sc_lv 62 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln7", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln7", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln7 { ap_stable {  { sext_ln7 in_data 0 62 } } }
	stream_in { ap_fifo {  { stream_in_din fifo_data_out 1 48 }  { stream_in_full_n fifo_status_empty 0 1 }  { stream_in_write fifo_data_in 1 1 }  { stream_in_num_data_valid fifo_update 0 3 }  { stream_in_fifo_cap fifo_data 0 3 } } }
}
