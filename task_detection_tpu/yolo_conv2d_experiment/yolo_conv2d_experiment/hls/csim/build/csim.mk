...
HLS_SOURCES = ../../../../yolo_conv_tb.cpp ../../../../yolo_conv.cpp
...
$(ObjDir)/yolo_conv_tb.o: ../../../../yolo_conv_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../yolo_conv_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/yolo_conv_tb.d

$(ObjDir)/yolo_conv.o: ../../../../yolo_conv.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../yolo_conv.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=yolo_conv_layer $(IFLAG) $(DFLAG) $< -o $@ ; \
