...
module yolo_backbone_v4_Block_entry_proc_1_Pipeline_VITIS_LOOP_273_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [6:0] oc_3_reg_127;
reg    ap_block_pp0_stage0_11001;
reg   [6:0] oc_3_reg_127_pp0_iter1_reg;
reg   [15:0] gmem2_addr_read_reg_136;
wire   [63:0] zext_ln273_fu_111_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [6:0] oc_fu_48;
wire   [6:0] add_ln273_fu_94_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_oc_3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln273_fu_88_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln273_fu_88_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln273_fu_94_p2 = (ap_sig_allocacmp_oc_3 + 7'd1);
...
assign icmp_ln273_fu_88_p2 = ((ap_sig_allocacmp_oc_3 == 7'd64) ? 1'b1 : 1'b0);

assign l2_b_address0 = zext_ln273_fu_111_p1;

assign l2_b_ce0 = l2_b_ce0_local;

assign l2_b_d0 = gmem2_addr_read_reg_136;

assign l2_b_we0 = l2_b_we0_local;
...
assign zext_ln273_fu_111_p1 = oc_3_reg_127_pp0_iter1_reg;

endmodule //yolo_backbone_v4_Block_entry_proc_1_Pipeline_VITIS_LOOP_273_3
