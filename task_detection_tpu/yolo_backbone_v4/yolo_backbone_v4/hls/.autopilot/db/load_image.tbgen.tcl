...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "image_in","offset": { "type": "dynamic","port_name": "image_in","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "s_img_in", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ s_img_in_din sc_out sc_lv 512 signal 2 } 
	{ s_img_in_full_n sc_in sc_logic 1 signal 2 } 
	{ s_img_in_write sc_out sc_logic 1 signal 2 } 
	{ s_img_in_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ s_img_in_fifo_cap sc_in sc_lv 3 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_img_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "s_img_in", "role": "din" }} , 
 	{ "name": "s_img_in_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_img_in", "role": "full_n" }} , 
 	{ "name": "s_img_in_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_img_in", "role": "write" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1163", "Max" : "1163"}
...
set Spec2ImplPortList { 
	...
	s_img_in { ap_fifo {  { s_img_in_din fifo_data_out 1 512 }  { s_img_in_full_n fifo_status_empty 0 1 }  { s_img_in_write fifo_data_in 1 1 }  { s_img_in_num_data_valid fifo_update 0 3 }  { s_img_in_fifo_cap fifo_data 0 3 } } }
}
