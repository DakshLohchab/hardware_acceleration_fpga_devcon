; ModuleID = '/home/dlohchab/projects/Verilog/DVCON/task_detection_tpu/yolo_backbone_v4/yolo_backbone_v4/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_yolo_backbone_v4_ir(%"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly "maxi" %image_in, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly "maxi" %l1_w_in, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly "maxi" %l1_b_in, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly "maxi" %l2_w_in, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly "maxi" %l2_b_in, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull "maxi" %image_out) local_unnamed_addr #0 {
entry:
  %image_in_copy = alloca i16, align 512
  %l1_w_in_copy = alloca i16, align 512
  %l1_b_in_copy = alloca i16, align 512
  %l2_w_in_copy = alloca i16, align 512
  %l2_b_in_copy = alloca i16, align 512
  %image_out_copy = alloca i16, align 512
  call fastcc void @copy_in(%"struct.ap_fixed<16, 6>"* nonnull %image_in, i16* nonnull align 512 %image_in_copy, %"struct.ap_fixed<16, 6>"* nonnull %l1_w_in, i16* nonnull align 512 %l1_w_in_copy, %"struct.ap_fixed<16, 6>"* nonnull %l1_b_in, i16* nonnull align 512 %l1_b_in_copy, %"struct.ap_fixed<16, 6>"* nonnull %l2_w_in, i16* nonnull align 512 %l2_w_in_copy, %"struct.ap_fixed<16, 6>"* nonnull %l2_b_in, i16* nonnull align 512 %l2_b_in_copy, %"struct.ap_fixed<16, 6>"* nonnull %image_out, i16* nonnull align 512 %image_out_copy)
  call void @apatb_yolo_backbone_v4_hw(i16* %image_in_copy, i16* %l1_w_in_copy, i16* %l1_b_in_copy, i16* %l2_w_in_copy, i16* %l2_b_in_copy, i16* %image_out_copy)
  call void @copy_back(%"struct.ap_fixed<16, 6>"* %image_in, i16* %image_in_copy, %"struct.ap_fixed<16, 6>"* %l1_w_in, i16* %l1_w_in_copy, %"struct.ap_fixed<16, 6>"* %l1_b_in, i16* %l1_b_in_copy, %"struct.ap_fixed<16, 6>"* %l2_w_in, i16* %l2_w_in_copy, %"struct.ap_fixed<16, 6>"* %l2_b_in, i16* %l2_b_in_copy, %"struct.ap_fixed<16, 6>"* %image_out, i16* %image_out_copy)
  ret void
}
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.22"(i16* align 512 %1, %"struct.ap_fixed<16, 6>"* %0)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.22"(i16* align 512 %3, %"struct.ap_fixed<16, 6>"* %2)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.22"(i16* align 512 %5, %"struct.ap_fixed<16, 6>"* %4)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.22"(i16* align 512 %7, %"struct.ap_fixed<16, 6>"* %6)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.22"(i16* align 512 %9, %"struct.ap_fixed<16, 6>"* %8)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.22"(i16* align 512 %11, %"struct.ap_fixed<16, 6>"* %10)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.22"(i16* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_fixed<16, 6>"* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
...
declare void @apatb_yolo_backbone_v4_hw(i16*, i16*, i16*, i16*, i16*, i16*)
...
declare void @yolo_backbone_v4_hw_stub(%"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull)

define void @yolo_backbone_v4_hw_stub_wrapper(i16*, i16*, i16*, i16*, i16*, i16*) #4 {
entry:
  ...
  call void @yolo_backbone_v4_hw_stub(%"struct.ap_fixed<16, 6>"* %7, %"struct.ap_fixed<16, 6>"* %9, %"struct.ap_fixed<16, 6>"* %11, %"struct.ap_fixed<16, 6>"* %13, %"struct.ap_fixed<16, 6>"* %15, %"struct.ap_fixed<16, 6>"* %17)
