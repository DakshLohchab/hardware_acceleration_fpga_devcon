...
set C_modelArgList {
	{ s_l2_out int 1024 regular {fifo 0 volatile }  }
	{ s_res_sync int 1024 regular {fifo 0 volatile }  }
	{ s_add_out int 1024 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "s_l2_out", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY"} , 
 	{ "Name" : "s_res_sync", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY"} , 
 	{ "Name" : "s_add_out", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ s_l2_out_dout sc_in sc_lv 1024 signal 0 } 
	...
	{ s_res_sync_dout sc_in sc_lv 1024 signal 1 } 
	{ s_res_sync_empty_n sc_in sc_logic 1 signal 1 } 
	{ s_res_sync_read sc_out sc_logic 1 signal 1 } 
	{ s_res_sync_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ s_res_sync_fifo_cap sc_in sc_lv 4 signal 1 } 
	{ s_add_out_din sc_out sc_lv 1024 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_l2_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "s_l2_out", "role": "dout" }} , 
 	...
 	{ "name": "s_res_sync_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "s_res_sync", "role": "dout" }} , 
 	...
 	{ "name": "s_res_sync_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "s_res_sync", "role": "num_data_valid" }} , 
 	{ "name": "s_res_sync_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "s_res_sync", "role": "fifo_cap" }} , 
 	{ "name": "s_add_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "s_add_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	s_l2_out { ap_fifo {  { s_l2_out_dout fifo_data_out 0 1024 }  { s_l2_out_empty_n fifo_status_empty 0 1 }  { s_l2_out_read fifo_data_in 1 1 }  { s_l2_out_num_data_valid fifo_update 0 3 }  { s_l2_out_fifo_cap fifo_data 0 3 } } }
	s_res_sync { ap_fifo {  { s_res_sync_dout fifo_data_out 0 1024 }  { s_res_sync_empty_n fifo_status_empty 0 1 }  { s_res_sync_read fifo_data_in 1 1 }  { s_res_sync_num_data_valid fifo_update 0 4 }  { s_res_sync_fifo_cap fifo_data 0 4 } } }
	s_add_out { ap_fifo {  { s_add_out_din fifo_data_out 1 1024 }  { s_add_out_full_n fifo_status_empty 0 1 }  { s_add_out_write fifo_data_in 1 1 }  { s_add_out_num_data_valid fifo_update 0 32 }  { s_add_out_fifo_cap fifo_data 0 32 } } }
}
