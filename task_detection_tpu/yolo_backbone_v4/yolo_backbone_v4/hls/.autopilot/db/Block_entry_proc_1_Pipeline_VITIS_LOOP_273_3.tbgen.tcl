set moduleName Block_entry_proc_1_Pipeline_VITIS_LOOP_273_3
set isTopModule 0
...
set cdfgNum 21
set C_modelName {Block_entry_proc.1_Pipeline_VITIS_LOOP_273_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict l2_b { MEM_WIDTH 16 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem2 int 16 regular {axi_master 0}  }
	{ sext_ln273 int 63 regular  }
	{ l2_b int 16 regular {array 64 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ sext_ln273 sc_in sc_lv 63 signal 1 } 
	{ l2_b_address0 sc_out sc_lv 6 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "l2_b_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "l2_b", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	l2_b { ap_memory {  { l2_b_address0 mem_address 1 6 }  { l2_b_ce0 mem_ce 1 1 }  { l2_b_we0 mem_we 1 1 }  { l2_b_d0 mem_din 1 16 } } }
}
