...
set cdfgNum 21
set C_modelName {store_image}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ s_pool_out int 1024 regular {fifo 0 volatile }  }
	{ gmem3 int 16 regular {axi_master 1}  }
	{ image_out int 64 regular {fifo 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "s_pool_out", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY"} , 
 	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "image_out","offset": { "type": "dynamic","port_name": "image_out","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "image_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ s_pool_out_dout sc_in sc_lv 1024 signal 0 } 
	{ s_pool_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ s_pool_out_read sc_out sc_logic 1 signal 0 } 
	{ s_pool_out_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ s_pool_out_fifo_cap sc_in sc_lv 3 signal 0 } 
	...
	{ m_axi_gmem3_0_WDATA sc_out sc_lv 16 signal 1 } 
	{ m_axi_gmem3_0_WSTRB sc_out sc_lv 2 signal 1 } 
	...
	{ m_axi_gmem3_0_RDATA sc_in sc_lv 16 signal 1 } 
	{ m_axi_gmem3_0_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem3_0_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_gmem3_0_RFIFONUM sc_in sc_lv 10 signal 1 } 
	...
	{ image_out_dout sc_in sc_lv 64 signal 2 } 
	{ image_out_empty_n sc_in sc_logic 1 signal 2 } 
	{ image_out_read sc_out sc_logic 1 signal 2 } 
	{ image_out_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ image_out_fifo_cap sc_in sc_lv 4 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_pool_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "s_pool_out", "role": "dout" }} , 
 	{ "name": "s_pool_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_pool_out", "role": "empty_n" }} , 
 	{ "name": "s_pool_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_pool_out", "role": "read" }} , 
 	{ "name": "s_pool_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "s_pool_out", "role": "num_data_valid" }} , 
 	{ "name": "s_pool_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "s_pool_out", "role": "fifo_cap" }} , 
 	...
 	{ "name": "image_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "image_out", "role": "dout" }} , 
 	...
 	{ "name": "image_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "image_out", "role": "num_data_valid" }} , 
 	{ "name": "image_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "image_out", "role": "fifo_cap" }}  ]}
...
set Spec2ImplPortList { 
	s_pool_out { ap_fifo {  { s_pool_out_dout fifo_data_out 0 1024 }  { s_pool_out_empty_n fifo_status_empty 0 1 }  { s_pool_out_read fifo_data_in 1 1 }  { s_pool_out_num_data_valid fifo_update 0 3 }  { s_pool_out_fifo_cap fifo_data 0 3 } } }
	...
	image_out { ap_fifo {  { image_out_dout fifo_data_out 0 64 }  { image_out_empty_n fifo_status_empty 0 1 }  { image_out_read fifo_data_in 1 1 }  { image_out_num_data_valid fifo_update 0 4 }  { image_out_fifo_cap fifo_data 0 4 } } }
}
