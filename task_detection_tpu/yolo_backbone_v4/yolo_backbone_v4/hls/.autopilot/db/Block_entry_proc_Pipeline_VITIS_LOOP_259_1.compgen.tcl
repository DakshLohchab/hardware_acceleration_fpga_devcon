...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename l1_b \
    op interface \
    ports { l1_b_address0 { O 6 vector } l1_b_ce0 { O 1 bit } l1_b_we0 { O 1 bit } l1_b_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'l1_b'"
}
}
