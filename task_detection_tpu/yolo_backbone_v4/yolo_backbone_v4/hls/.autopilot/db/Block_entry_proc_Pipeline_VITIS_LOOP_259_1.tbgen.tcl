set moduleName Block_entry_proc_Pipeline_VITIS_LOOP_259_1
set isTopModule 0
...
set cdfgNum 21
set C_modelName {Block_entry_proc_Pipeline_VITIS_LOOP_259_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict l1_b { MEM_WIDTH 16 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 0}  }
	{ sext_ln259 int 63 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "l1_w_in","offset": { "type": "dynamic","port_name": "l1_w_in","bundle": "control_r"},"direction": "READONLY"},{"cName": "l1_b_in","offset": { "type": "dynamic","port_name": "l1_b_in","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln259", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln259 sc_in sc_lv 63 signal 1 } 
	{ l1_b_address0 sc_out sc_lv 6 signal 2 } 
	{ l1_b_ce0 sc_out sc_logic 1 signal 2 } 
	{ l1_b_we0 sc_out sc_logic 1 signal 2 } 
	{ l1_b_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln259", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln259", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln259 { ap_none {  { sext_ln259 in_data 0 63 } } }
