...
HLS_SOURCES = ../../../../yolo_npu_v2_tb.cpp ../../../../yolo_npu_v2.cpp
...
$(ObjDir)/yolo_npu_v2_tb.o: ../../../../yolo_npu_v2_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../yolo_npu_v2_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/yolo_npu_v2_tb.d

$(ObjDir)/yolo_npu_v2.o: ../../../../yolo_npu_v2.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../yolo_npu_v2.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=yolo_npu_v2_core $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/yolo_npu_v2.d
