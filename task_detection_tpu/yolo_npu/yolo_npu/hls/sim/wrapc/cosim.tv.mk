...
TOOLCHAIN += --gcc-toolchain=/home/dlohchab/Xilinx/2025.2/Vitis/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/yolo_npu_v2_tb.cpp_pre.cpp.tb.o : yolo_npu_v2_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling yolo_npu_v2_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/yolo_npu_v2.cpp_pre.cpp.tb.o : yolo_npu_v2.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling yolo_npu_v2.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
