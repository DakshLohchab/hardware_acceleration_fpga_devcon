...
entity task_detection_accel_fifo_w64_d8_S is 
    generic (
...
architecture rtl of task_detection_accel_fifo_w64_d8_S is
...
------------------------Component----------------------
    component task_detection_accel_fifo_w64_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
...
begin
----------------------- Instantiation -----------------------
    U_task_detection_accel_fifo_w64_d8_S_ShiftReg : task_detection_accel_fifo_w64_d8_S_ShiftReg
    generic map (
...
entity task_detection_accel_fifo_w64_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end task_detection_accel_fifo_w64_d8_S_ShiftReg;

architecture rtl of task_detection_accel_fifo_w64_d8_S_ShiftReg is
