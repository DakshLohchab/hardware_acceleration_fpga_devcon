...
module task_detection_accel_Block_entry_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] gmem1_addr_reg_104;
reg    ap_block_state1;
reg   [31:0] p_read_2_reg_111;
wire  signed [63:0] sext_ln414_fu_94_p1;
wire   [61:0] trunc_ln_fu_84_p4;
reg   [7:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((m_axi_gmem1_0_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state8))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    ap_block_state1 = ((output_r_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end
...
assign m_axi_gmem1_0_AWADDR = gmem1_addr_reg_104;
...
assign m_axi_gmem1_0_WDATA = p_read_2_reg_111;
...
assign sext_ln414_fu_94_p1 = $signed(trunc_ln_fu_84_p4);

assign trunc_ln_fu_84_p4 = {{output_r_dout[63:2]}};

endmodule //task_detection_accel_Block_entry_proc
