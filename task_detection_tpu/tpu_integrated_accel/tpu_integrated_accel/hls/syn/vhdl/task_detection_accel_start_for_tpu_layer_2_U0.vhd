...
entity task_detection_accel_start_for_tpu_layer_2_U0 is 
    generic (
...
architecture rtl of task_detection_accel_start_for_tpu_layer_2_U0 is
...
------------------------Component----------------------
    component task_detection_accel_start_for_tpu_layer_2_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_task_detection_accel_start_for_tpu_layer_2_U0_ShiftReg : task_detection_accel_start_for_tpu_layer_2_U0_ShiftReg
    generic map (
...
entity task_detection_accel_start_for_tpu_layer_2_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end task_detection_accel_start_for_tpu_layer_2_U0_ShiftReg;

architecture rtl of task_detection_accel_start_for_tpu_layer_2_U0_ShiftReg is
