...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename weights \
    op interface \
    ports { weights_address0 { O 6 vector } weights_ce0 { O 1 bit } weights_q0 { I 4 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_l3_to_l4_dout { I 16 vector } stream_l3_to_l4_empty_n { I 1 bit } stream_l3_to_l4_read { O 1 bit } stream_l3_to_l4_num_data_valid { I 3 vector } stream_l3_to_l4_fifo_cap { I 3 vector } } \
} "
}
