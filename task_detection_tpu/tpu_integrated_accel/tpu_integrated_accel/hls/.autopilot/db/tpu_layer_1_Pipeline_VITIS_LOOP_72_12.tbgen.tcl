set moduleName tpu_layer_1_Pipeline_VITIS_LOOP_72_12
set isTopModule 0
...
set cdfgNum 28
set C_modelName {tpu_layer_1_Pipeline_VITIS_LOOP_72_12}
...
dict set ap_memory_interface_dict output_r { MEM_WIDTH 16 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict bias_2 { MEM_WIDTH 1 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ shl_ln int 8 regular  }
	{ y_tile int 16 regular {array 8 { 1 3 } 1 1 }  }
	{ output_r int 16 regular {array 256 { 0 3 } 0 1 }  }
	{ bias_2 int 1 regular {array 256 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "shl_ln", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bias_2", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ bias_2_address0 sc_out sc_lv 8 signal 3 } 
	{ bias_2_ce0 sc_out sc_logic 1 signal 3 } 
	{ bias_2_q0 sc_in sc_lv 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bias_2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "bias_2", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	bias_2 { ap_memory {  { bias_2_address0 mem_address 1 8 }  { bias_2_ce0 mem_ce 1 1 }  { bias_2_q0 mem_dout 0 1 } } }
}
