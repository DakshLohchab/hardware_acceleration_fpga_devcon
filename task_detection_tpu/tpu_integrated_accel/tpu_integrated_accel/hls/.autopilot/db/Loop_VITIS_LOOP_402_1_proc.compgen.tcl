...
set name task_detection_accel_fpext_32ns_64_2_no_dsp_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler task_detection_accel_sparsemux_9_3_16_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_in_din { O 16 vector } stream_in_full_n { I 1 bit } stream_in_write { O 1 bit } stream_in_num_data_valid { I 3 vector } stream_in_fifo_cap { I 3 vector } } \
} "
}
...
set InstName task_detection_accel_flow_control_loop_pipe_U
set CompName task_detection_accel_flow_control_loop_pipe
