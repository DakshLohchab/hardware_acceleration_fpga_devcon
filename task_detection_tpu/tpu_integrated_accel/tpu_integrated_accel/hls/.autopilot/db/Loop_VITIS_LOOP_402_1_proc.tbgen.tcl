set moduleName Loop_VITIS_LOOP_402_1_proc
set isTopModule 0
...
set cdfgNum 62
set C_modelName {Loop_VITIS_LOOP_402_1_proc}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ input_r int 64 regular  }
	{ gmem0 int 32 regular {axi_master 0}  }
	{ stream_in int 16 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "input_r", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "stream_in", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ stream_in_din sc_out sc_lv 16 signal 2 } 
	{ stream_in_full_n sc_in sc_logic 1 signal 2 } 
	{ stream_in_write sc_out sc_logic 1 signal 2 } 
	{ stream_in_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ stream_in_fifo_cap sc_in sc_lv 3 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "stream_in", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	stream_in { ap_fifo {  { stream_in_din fifo_data_out 1 16 }  { stream_in_full_n fifo_status_empty 0 1 }  { stream_in_write fifo_data_in 1 1 }  { stream_in_num_data_valid fifo_update 0 3 }  { stream_in_fifo_cap fifo_data 0 3 } } }
}
