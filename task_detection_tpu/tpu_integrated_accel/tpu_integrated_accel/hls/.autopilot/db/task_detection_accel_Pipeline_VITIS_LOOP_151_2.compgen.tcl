...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename l3_out \
    op interface \
    ports { l3_out_address0 { O 6 vector } l3_out_ce0 { O 1 bit } l3_out_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'l3_out'"
}
}
