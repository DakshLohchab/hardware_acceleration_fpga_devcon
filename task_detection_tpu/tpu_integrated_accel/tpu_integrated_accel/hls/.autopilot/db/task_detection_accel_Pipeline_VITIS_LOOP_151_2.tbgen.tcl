set moduleName task_detection_accel_Pipeline_VITIS_LOOP_151_2
set isTopModule 0
...
set cdfgNum 28
set C_modelName {task_detection_accel_Pipeline_VITIS_LOOP_151_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict l3_out { MEM_WIDTH 16 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	{ l3_out int 16 regular {array 64 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "l3_out", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ l3_out_address0 sc_out sc_lv 6 signal 0 } 
	{ l3_out_ce0 sc_out sc_logic 1 signal 0 } 
	{ l3_out_q0 sc_in sc_lv 16 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "l3_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "l3_out", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	l3_out { ap_memory {  { l3_out_address0 mem_address 1 6 }  { l3_out_ce0 mem_ce 1 1 }  { l3_out_q0 mem_dout 0 16 } } }
