set moduleName tpu_layer_1_Pipeline_VITIS_LOOP_47_2
set isTopModule 0
...
set cdfgNum 28
set C_modelName {tpu_layer_1_Pipeline_VITIS_LOOP_47_2}
...
set portList { 
	...
	{ x_padded_address0 sc_out sc_lv 8 signal 0 } 
	{ x_padded_ce0 sc_out sc_logic 1 signal 0 } 
	{ x_padded_we0 sc_out sc_logic 1 signal 0 } 
	{ x_padded_d0 sc_out sc_lv 16 signal 0 } 
}
set NewPortList {[ 
