...
using hls::sim::Byte;
extern "C" void task_detection_accel(Byte<4>*, Byte<4>*, int, int, int, int);
extern "C" void apatb_task_detection_accel_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, int __xlx_apatb_param_task_id, int __xlx_apatb_param_top_k) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  task_detection_accel(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_output_r, __xlx_apatb_param_task_id, __xlx_apatb_param_top_k);
