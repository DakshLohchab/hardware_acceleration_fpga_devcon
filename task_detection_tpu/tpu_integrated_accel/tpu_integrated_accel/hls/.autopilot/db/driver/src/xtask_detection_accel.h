...
// 
// ==============================================================
#ifndef XTASK_DETECTION_ACCEL_H
#define XTASK_DETECTION_ACCEL_H
...
#include <stddef.h>
#endif
#include "xtask_detection_accel_hw.h"
...
typedef struct {
    ...
    u64 Control_r_BaseAddress;
    u32 IsReady;
} XTask_detection_accel;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XTask_detection_accel_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XTask_detection_accel_ReadReg(BaseAddress, RegOffset) \
