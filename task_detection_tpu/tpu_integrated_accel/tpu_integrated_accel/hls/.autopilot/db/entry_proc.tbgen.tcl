...
set Spec2ImplPortList { 
	...
	output_r_c { ap_fifo {  { output_r_c_din fifo_data_out 1 64 }  { output_r_c_full_n fifo_status_empty 0 1 }  { output_r_c_write fifo_data_in 1 1 }  { output_r_c_num_data_valid fifo_update 0 4 }  { output_r_c_fifo_cap fifo_data 0 4 } } }
}
