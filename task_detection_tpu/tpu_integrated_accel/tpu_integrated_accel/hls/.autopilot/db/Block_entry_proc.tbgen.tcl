...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control_r"},"direction": "WRITEONLY"}]}]} ]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_fifo {  { output_r_dout fifo_data_out 0 64 }  { output_r_empty_n fifo_status_empty 0 1 }  { output_r_read fifo_data_in 1 1 }  { output_r_num_data_valid fifo_update 0 4 }  { output_r_fifo_cap fifo_data 0 4 } } }
