...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename y_tile_1 \
    op interface \
    ports { y_tile_1_address0 { O 3 vector } y_tile_1_ce0 { O 1 bit } y_tile_1_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'y_tile_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename l2_out \
    op interface \
    ports { l2_out_address0 { O 7 vector } l2_out_ce0 { O 1 bit } l2_out_we0 { O 1 bit } l2_out_d0 { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename bias_1 \
    op interface \
    ports { bias_1_address0 { O 7 vector } bias_1_ce0 { O 1 bit } bias_1_q0 { I 1 vector } } \
} "
} else {
