...
set C_modelArgList {
	{ s_pool_out int 512 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "s_pool_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ s_pool_out_dout sc_in sc_lv 512 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_pool_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "s_pool_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	s_pool_out { ap_fifo {  { s_pool_out_dout fifo_data_out 0 512 }  { s_pool_out_empty_n fifo_status_empty 0 1 }  { s_pool_out_read fifo_data_in 1 1 }  { s_pool_out_num_data_valid fifo_update 0 3 }  { s_pool_out_fifo_cap fifo_data 0 3 } } }
