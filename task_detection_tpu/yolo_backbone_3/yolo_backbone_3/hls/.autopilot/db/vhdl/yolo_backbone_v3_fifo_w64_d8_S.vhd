...
entity yolo_backbone_v3_fifo_w64_d8_S is 
    generic (
...
architecture rtl of yolo_backbone_v3_fifo_w64_d8_S is
...
------------------------Component----------------------
    component yolo_backbone_v3_fifo_w64_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
...
begin
----------------------- Instantiation -----------------------
    U_yolo_backbone_v3_fifo_w64_d8_S_ShiftReg : yolo_backbone_v3_fifo_w64_d8_S_ShiftReg
    generic map (
...
entity yolo_backbone_v3_fifo_w64_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end yolo_backbone_v3_fifo_w64_d8_S_ShiftReg;

architecture rtl of yolo_backbone_v3_fifo_w64_d8_S_ShiftReg is
