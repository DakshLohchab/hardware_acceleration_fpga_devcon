...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { s_pool_out_dout { I 512 vector } s_pool_out_empty_n { I 1 bit } s_pool_out_read { O 1 bit } s_pool_out_num_data_valid { I 3 vector } s_pool_out_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { image_out_dout { I 64 vector } image_out_empty_n { I 1 bit } image_out_read { O 1 bit } image_out_num_data_valid { I 4 vector } image_out_fifo_cap { I 4 vector } } \
} "
}
