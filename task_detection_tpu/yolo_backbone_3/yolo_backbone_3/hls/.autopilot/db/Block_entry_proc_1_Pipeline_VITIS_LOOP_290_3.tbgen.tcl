set moduleName Block_entry_proc_1_Pipeline_VITIS_LOOP_290_3
set isTopModule 0
...
set cdfgNum 21
set C_modelName {Block_entry_proc.1_Pipeline_VITIS_LOOP_290_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict l2_b { MEM_WIDTH 16 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem2 int 16 regular {axi_master 0}  }
	{ sext_ln290 int 63 regular  }
	{ l2_b int 16 regular {array 32 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "l2_w_in","offset": { "type": "dynamic","port_name": "l2_w_in","bundle": "control_r"},"direction": "READONLY"},{"cName": "l2_b_in","offset": { "type": "dynamic","port_name": "l2_b_in","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln290", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "l2_b", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln290 sc_in sc_lv 63 signal 1 } 
	{ l2_b_address0 sc_out sc_lv 5 signal 2 } 
	{ l2_b_ce0 sc_out sc_logic 1 signal 2 } 
	{ l2_b_we0 sc_out sc_logic 1 signal 2 } 
	{ l2_b_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln290", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln290", "role": "default" }} , 
 	{ "name": "l2_b_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "l2_b", "role": "address0" }} , 
 	{ "name": "l2_b_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "l2_b", "role": "ce0" }} , 
 	{ "name": "l2_b_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "l2_b", "role": "we0" }} , 
 	{ "name": "l2_b_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "l2_b", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln290 { ap_none {  { sext_ln290 in_data 0 63 } } }
	l2_b { ap_memory {  { l2_b_address0 mem_address 1 5 }  { l2_b_ce0 mem_ce 1 1 }  { l2_b_we0 mem_we 1 1 }  { l2_b_d0 mem_din 1 16 } } }
}
