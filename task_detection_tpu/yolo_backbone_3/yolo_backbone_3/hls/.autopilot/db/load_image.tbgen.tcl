...
set C_modelArgList {
	...
	{ s_img_in int 256 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "image_in","offset": { "type": "dynamic","port_name": "image_in","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "s_img_in", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ s_img_in_din sc_out sc_lv 256 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_img_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "s_img_in", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	s_img_in { ap_fifo {  { s_img_in_din fifo_data_out 1 256 }  { s_img_in_full_n fifo_status_empty 0 1 }  { s_img_in_write fifo_data_in 1 1 }  { s_img_in_num_data_valid fifo_update 0 3 }  { s_img_in_fifo_cap fifo_data 0 3 } } }
}
