; ModuleID = '/home/dlohchab/projects/Verilog/DVCON/task_detection_tpu/yolo_backbone_3/yolo_backbone_3/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_yolo_backbone_v3_hw(i16* %image_in_copy, i16* %l1_w_in_copy, i16* %l1_b_in_copy, i16* %l2_w_in_copy, i16* %l2_b_in_copy, i16* %image_out_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.20"(i16* align 512 %1, %"struct.ap_fixed<16, 6>"* %0)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.20"(i16* align 512 %3, %"struct.ap_fixed<16, 6>"* %2)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.20"(i16* align 512 %5, %"struct.ap_fixed<16, 6>"* %4)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.20"(i16* align 512 %7, %"struct.ap_fixed<16, 6>"* %6)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.20"(i16* align 512 %9, %"struct.ap_fixed<16, 6>"* %8)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.20"(i16* align 512 %11, %"struct.ap_fixed<16, 6>"* %10)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_fixed<16, 6>.20"(i16* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_fixed<16, 6>"* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
...
declare void @apatb_yolo_backbone_v3_hw(i16*, i16*, i16*, i16*, i16*, i16*)
...
declare void @yolo_backbone_v3_hw_stub(%"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6>"* noalias nocapture nonnull)

define void @yolo_backbone_v3_hw_stub_wrapper(i16*, i16*, i16*, i16*, i16*, i16*) #4 {
entry:
  ...
  call void @yolo_backbone_v3_hw_stub(%"struct.ap_fixed<16, 6>"* %7, %"struct.ap_fixed<16, 6>"* %9, %"struct.ap_fixed<16, 6>"* %11, %"struct.ap_fixed<16, 6>"* %13, %"struct.ap_fixed<16, 6>"* %15, %"struct.ap_fixed<16, 6>"* %17)
