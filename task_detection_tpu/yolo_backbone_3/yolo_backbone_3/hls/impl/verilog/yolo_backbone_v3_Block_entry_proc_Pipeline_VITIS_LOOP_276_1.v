...
module yolo_backbone_v3_Block_entry_proc_Pipeline_VITIS_LOOP_276_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] trunc_ln276_fu_119_p1;
reg   [0:0] trunc_ln276_reg_165;
reg   [0:0] trunc_ln276_reg_165_pp0_iter1_reg;
reg   [3:0] lshr_ln_reg_169;
reg   [3:0] lshr_ln_reg_169_pp0_iter1_reg;
reg   [15:0] gmem1_addr_read_reg_174;
wire   [63:0] zext_ln276_fu_144_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [5:0] oc_fu_54;
wire   [5:0] add_ln276_fu_113_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_oc_3;
wire    ap_block_pp0_stage0;
reg    l1_b_0_we0_local;
wire    ap_block_pp0_stage0_11001_grp0;
reg    ap_block_pp0_stage0_subdone_grp0_done_reg;
wire    ap_block_pp0_stage0_subdone_grp0;
reg    l1_b_0_ce0_local;
reg    l1_b_1_we0_local;
reg    l1_b_1_ce0_local;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln276_fu_107_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        lshr_ln_reg_169 <= {{ap_sig_allocacmp_oc_3[4:1]}};
...
always @ (*) begin
    if (((icmp_ln276_fu_107_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        l1_b_0_ce0_local = 1'b1;
    end else begin
        l1_b_0_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln276_reg_165_pp0_iter1_reg == 1'd0))) begin
        l1_b_0_we0_local = 1'b1;
    end else begin
        l1_b_0_we0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        l1_b_1_ce0_local = 1'b1;
    end else begin
        l1_b_1_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (trunc_ln276_reg_165_pp0_iter1_reg == 1'd1))) begin
        l1_b_1_we0_local = 1'b1;
    end else begin
        l1_b_1_we0_local = 1'b0;
    end
end
...
assign add_ln276_fu_113_p2 = (ap_sig_allocacmp_oc_3 + 6'd1);
...
assign icmp_ln276_fu_107_p2 = ((ap_sig_allocacmp_oc_3 == 6'd32) ? 1'b1 : 1'b0);

assign l1_b_0_address0 = zext_ln276_fu_144_p1;

assign l1_b_0_ce0 = l1_b_0_ce0_local;

assign l1_b_0_d0 = gmem1_addr_read_reg_174;

assign l1_b_0_we0 = l1_b_0_we0_local;

assign l1_b_1_address0 = zext_ln276_fu_144_p1;

assign l1_b_1_ce0 = l1_b_1_ce0_local;

assign l1_b_1_d0 = gmem1_addr_read_reg_174;

assign l1_b_1_we0 = l1_b_1_we0_local;
...
assign trunc_ln276_fu_119_p1 = ap_sig_allocacmp_oc_3[0:0];

assign zext_ln276_fu_144_p1 = lshr_ln_reg_169_pp0_iter1_reg;

endmodule //yolo_backbone_v3_Block_entry_proc_Pipeline_VITIS_LOOP_276_1
