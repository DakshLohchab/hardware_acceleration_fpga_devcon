...
set ArgLastReadFirstWriteLatency {
	task_detection_accel {
		...
		gmem1 {Type O LastRead 24 FirstWrite 23}
		...
		weights_1 {Type IO LastRead -1 FirstWrite -1}
		...
		weights_2 {Type IO LastRead -1 FirstWrite -1}
		bias_2 {Type IO LastRead -1 FirstWrite -1}
		initialized {Type IO LastRead -1 FirstWrite -1}
		linear_64_1_float_float_weights_1 {Type IO LastRead -1 FirstWrite -1}}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "87339", "Max" : "174451"}
	, {"Name" : "Interval", "Min" : "87340", "Max" : "174452"}
]}
