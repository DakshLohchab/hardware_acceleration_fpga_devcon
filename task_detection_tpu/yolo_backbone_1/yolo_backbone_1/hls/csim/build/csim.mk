...
HLS_SOURCES = ../../../../yolo_block_tb.cpp ../../../../yolo_block.cpp
...
$(ObjDir)/yolo_block_tb.o: ../../../../yolo_block_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../yolo_block_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/yolo_block_tb.d

$(ObjDir)/yolo_block.o: ../../../../yolo_block.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../yolo_block.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=yolo_backbone_block $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/yolo_block.d
