...
entity yolo_backbone_block_fifo_w256_d2_S is 
    generic (
...
architecture rtl of yolo_backbone_block_fifo_w256_d2_S is
...
------------------------Component----------------------
    component yolo_backbone_block_fifo_w256_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 256;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_yolo_backbone_block_fifo_w256_d2_S_ShiftReg : yolo_backbone_block_fifo_w256_d2_S_ShiftReg
    generic map (
...
entity yolo_backbone_block_fifo_w256_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 256;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end yolo_backbone_block_fifo_w256_d2_S_ShiftReg;

architecture rtl of yolo_backbone_block_fifo_w256_d2_S_ShiftReg is
