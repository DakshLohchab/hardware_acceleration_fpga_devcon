set moduleName store_image_Pipeline_VITIS_LOOP_212_1
set isTopModule 0
...
set cdfgNum 18
set C_modelName {store_image_Pipeline_VITIS_LOOP_212_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem3 int 16 regular {axi_master 1}  }
	{ sext_ln212 int 63 regular {ap_stable 0} }
	{ stream_pool_out int 512 regular {fifo 0 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "image_out","offset": { "type": "dynamic","port_name": "image_out","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln212", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "stream_pool_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem3_0_WDATA sc_out sc_lv 16 signal 0 } 
	{ m_axi_gmem3_0_WSTRB sc_out sc_lv 2 signal 0 } 
	...
	{ m_axi_gmem3_0_RDATA sc_in sc_lv 16 signal 0 } 
	{ m_axi_gmem3_0_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem3_0_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_gmem3_0_RFIFONUM sc_in sc_lv 10 signal 0 } 
	...
	{ stream_pool_out_dout sc_in sc_lv 512 signal 2 } 
	{ stream_pool_out_empty_n sc_in sc_logic 1 signal 2 } 
	{ stream_pool_out_read sc_out sc_logic 1 signal 2 } 
	{ stream_pool_out_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ stream_pool_out_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ sext_ln212 sc_in sc_lv 63 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_pool_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "stream_pool_out", "role": "dout" }} , 
 	{ "name": "stream_pool_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_pool_out", "role": "empty_n" }} , 
 	{ "name": "stream_pool_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_pool_out", "role": "read" }} , 
 	{ "name": "stream_pool_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "stream_pool_out", "role": "num_data_valid" }} , 
 	{ "name": "stream_pool_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "stream_pool_out", "role": "fifo_cap" }} , 
 	{ "name": "sext_ln212", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln212", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln212 { ap_stable {  { sext_ln212 in_data 0 63 } } }
	stream_pool_out { ap_fifo {  { stream_pool_out_dout fifo_data_out 0 512 }  { stream_pool_out_empty_n fifo_status_empty 0 1 }  { stream_pool_out_read fifo_data_in 1 1 }  { stream_pool_out_num_data_valid fifo_update 0 3 }  { stream_pool_out_fifo_cap fifo_data 0 3 } } }
}
