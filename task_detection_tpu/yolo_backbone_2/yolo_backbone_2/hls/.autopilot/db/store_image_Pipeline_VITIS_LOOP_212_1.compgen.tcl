...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_pool_out_dout { I 512 vector } stream_pool_out_empty_n { I 1 bit } stream_pool_out_read { O 1 bit } stream_pool_out_num_data_valid { I 3 vector } stream_pool_out_fifo_cap { I 3 vector } } \
} "
}
