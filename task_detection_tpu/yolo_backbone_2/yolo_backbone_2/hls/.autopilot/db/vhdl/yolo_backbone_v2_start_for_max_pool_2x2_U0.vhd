...
entity yolo_backbone_v2_start_for_max_pool_2x2_U0 is 
    generic (
...
architecture rtl of yolo_backbone_v2_start_for_max_pool_2x2_U0 is
...
------------------------Component----------------------
    component yolo_backbone_v2_start_for_max_pool_2x2_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_yolo_backbone_v2_start_for_max_pool_2x2_U0_ShiftReg : yolo_backbone_v2_start_for_max_pool_2x2_U0_ShiftReg
    generic map (
...
entity yolo_backbone_v2_start_for_max_pool_2x2_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end yolo_backbone_v2_start_for_max_pool_2x2_U0_ShiftReg;

architecture rtl of yolo_backbone_v2_start_for_max_pool_2x2_U0_ShiftReg is
