set moduleName load_image_Pipeline_VITIS_LOOP_203_1
set isTopModule 0
...
set cdfgNum 18
set C_modelName {load_image_Pipeline_VITIS_LOOP_203_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem0 int 16 regular {axi_master 0 stable }  }
	{ sext_ln203 int 63 regular {ap_stable 0} }
	{ stream_l1_in int 48 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "image_in","offset": { "type": "dynamic","port_name": "image_in","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln203", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "stream_l1_in", "interface" : "fifo", "bitwidth" : 48, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ stream_l1_in_din sc_out sc_lv 48 signal 2 } 
	{ stream_l1_in_full_n sc_in sc_logic 1 signal 2 } 
	{ stream_l1_in_write sc_out sc_logic 1 signal 2 } 
	{ stream_l1_in_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ stream_l1_in_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ sext_ln203 sc_in sc_lv 63 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_l1_in_din", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "stream_l1_in", "role": "din" }} , 
 	{ "name": "stream_l1_in_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_l1_in", "role": "full_n" }} , 
 	{ "name": "stream_l1_in_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stream_l1_in", "role": "write" }} , 
 	...
 	{ "name": "sext_ln203", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln203", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln203 { ap_stable {  { sext_ln203 in_data 0 63 } } }
	stream_l1_in { ap_fifo {  { stream_l1_in_din fifo_data_out 1 48 }  { stream_l1_in_full_n fifo_status_empty 0 1 }  { stream_l1_in_write fifo_data_in 1 1 }  { stream_l1_in_num_data_valid fifo_update 0 3 }  { stream_l1_in_fifo_cap fifo_data 0 3 } } }
}
