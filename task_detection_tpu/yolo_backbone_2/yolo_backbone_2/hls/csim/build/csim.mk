...
HLS_SOURCES = ../../../../yolo_backbone_2_tb.cpp ../../../../yolo_backbone_2.cpp
...
$(ObjDir)/yolo_backbone_2_tb.o: ../../../../yolo_backbone_2_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../yolo_backbone_2_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/yolo_backbone_2_tb.d

$(ObjDir)/yolo_backbone_2.o: ../../../../yolo_backbone_2.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../yolo_backbone_2.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=yolo_backbone_v2 $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/yolo_backbone_2.d
