...
HLS_SOURCES = ../../../../../task_detection_tpu/tpu_tb.cpp ../../../../../task_detection_tpu/tpu_core.cpp
...
$(ObjDir)/tpu_tb.o: ../../../../../task_detection_tpu/tpu_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../task_detection_tpu/tpu_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tpu_tb.d

$(ObjDir)/tpu_core.o: ../../../../../task_detection_tpu/tpu_core.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../task_detection_tpu/tpu_core.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=matmul_tile_16x16 $(IFLAG) $(DFLAG) $< -o $@ ; \
