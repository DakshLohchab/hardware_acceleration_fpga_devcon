...
HLS_SOURCES = ../../../../../task_detection_tpu/systolic_16x16_tb.cpp ../../../../../task_detection_tpu/systolic_16x16.cpp ../../../../../task_detection_tpu/systolic_8x8.cpp ../../../../../task_detection_tpu/systolic_4x4.cpp ../../../../../task_detection_tpu/systolic_2x2.cpp ../../../../../task_detection_tpu/pe.cpp
...
$(ObjDir)/systolic_16x16_tb.o: ../../../../../task_detection_tpu/systolic_16x16_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../task_detection_tpu/systolic_16x16_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/systolic_16x16_tb.d

$(ObjDir)/systolic_16x16.o: ../../../../../task_detection_tpu/systolic_16x16.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../task_detection_tpu/systolic_16x16.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=systolic_16x16 $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/systolic_16x16.d
