...
set cdfgNum 2
set C_modelName {systolic_8x8}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict A_in { MEM_WIDTH 16 MEM_SIZE 16 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict B_in { MEM_WIDTH 16 MEM_SIZE 16 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict C_out { MEM_WIDTH 16 MEM_SIZE 128 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ A_in int 16 regular {array 8 { 1 1 } 1 1 }  }
	{ B_in int 16 regular {array 8 { 1 1 } 1 1 }  }
	{ C_out int 16 regular {array 64 { 0 0 } 0 1 }  }
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_in_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "A_in", "role": "address0" }} , 
 	...
 	{ "name": "A_in_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "A_in", "role": "address1" }} , 
 	...
 	{ "name": "B_in_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "B_in", "role": "address0" }} , 
 	...
 	{ "name": "B_in_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "B_in", "role": "address1" }} , 
 	...
 	{ "name": "C_out_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "C_out", "role": "address0" }} , 
 	...
 	{ "name": "C_out_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "C_out", "role": "address1" }} , 
...
set ArgLastReadFirstWriteLatency {
	systolic_8x8 {
		A_in {Type I LastRead 4 FirstWrite -1}
		B_in {Type I LastRead 4 FirstWrite -1}
...
set Spec2ImplPortList { 
	A_in { ap_memory {  { A_in_address0 mem_address 1 3 }  { A_in_ce0 mem_ce 1 1 }  { A_in_q0 mem_dout 0 16 }  { A_in_address1 MemPortADDR2 1 3 }  { A_in_ce1 MemPortCE2 1 1 }  { A_in_q1 MemPortDOUT2 0 16 } } }
	B_in { ap_memory {  { B_in_address0 mem_address 1 3 }  { B_in_ce0 mem_ce 1 1 }  { B_in_q0 mem_dout 0 16 }  { B_in_address1 MemPortADDR2 1 3 }  { B_in_ce1 MemPortCE2 1 1 }  { B_in_q1 MemPortDOUT2 0 16 } } }
	C_out { ap_memory {  { C_out_address0 mem_address 1 6 }  { C_out_ce0 mem_ce 1 1 }  { C_out_we0 mem_we 1 1 }  { C_out_d0 mem_din 1 16 }  { C_out_address1 MemPortADDR2 1 6 }  { C_out_ce1 MemPortCE2 1 1 }  { C_out_we1 MemPortWE2 1 1 }  { C_out_d1 MemPortDIN2 1 16 } } }
