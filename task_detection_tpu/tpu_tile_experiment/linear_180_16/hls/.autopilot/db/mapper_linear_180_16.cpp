...
using hls::sim::Byte;
extern "C" void linear_180_16(Byte<4>*, Byte<4>*);
extern "C" void apatb_linear_180_16_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_size_param_output_r = 16;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*4;
  // DUT call
  linear_180_16(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data());
