...
HLS_SOURCES = ../../../../../task_detection_tpu/tpu_tile_tb.cpp ../../../../../task_detection_tpu/mlp_engine.cpp
...
$(ObjDir)/tpu_tile_tb.o: ../../../../../task_detection_tpu/tpu_tile_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../task_detection_tpu/tpu_tile_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tpu_tile_tb.d

$(ObjDir)/mlp_engine.o: ../../../../../task_detection_tpu/mlp_engine.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../task_detection_tpu/mlp_engine.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=linear_180_16 $(IFLAG) $(DFLAG) $< -o $@ ; \
